    ...
    const fetchTables = async () => {
      try {
        ...
        const responseInscriptions = await axios.get(
          'https://impulso-local-back.onrender.com/api/inscriptions/tables?tableType=inscription&isPrimary=true',
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
        const responseProviders = await axios.get(
          'https://impulso-local-back.onrender.com/api/inscriptions/tables?tableType=provider&isPrimary=true',
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://impulso-local-back.onrender.com/api/inscriptions/download-multiple-zip`,
        requestData,
        {
          headers: { Authorization: `Bearer ${token}` },
